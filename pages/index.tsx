  ...
  return (
    <Flex w="100%" justifyContent='center' alignItems='center' >
      <Flex w={{ base: '90%', md: '70%', lg: '60%' }} direction='column' justifyContent='center' alignItems='center' >
        ...
        <Text mt={4} lineHeight='30px'>We can't, just as we can't talk in a language we haven't heard; we dream of things we haven't known.<br />However, we can see more, learn more, hear more, and know more because of the internet. Ten percent of the most successful companies today were started by those who came from humble backgrounds, which would not have been possible a hundred years ago. The more we connect, the more we know, and the more opportunities we create.</Text>
